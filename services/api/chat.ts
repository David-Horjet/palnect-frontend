...
export const chatService = {
  ...
  async sendMessage(token: string, conversationId: string, clientMessageId: string, message: string, mode?: "text" | "video", attachments?: Array<{ url: string; type: string; name?: string }>) {
