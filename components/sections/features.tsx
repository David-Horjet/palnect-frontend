...
export function FeaturesSection() {
  return (
    <section
      id="features"
      className="scroll-mt-17 overflow-hidden py-17.5 lg:py-22.5 xl:py-27.5"
    >
      <div className="mx-auto max-w-[1222px] px-4 sm:px-8 xl:px-0">
        ...
        <div className="relative">
          <div className="h-px bg-foreground/10 absolute left-1/2 top-1/2 hidden w-1/2 -translate-y-1/2 rotate-90 lg:left-1/4 lg:block lg:-translate-x-1/3"></div>
          <div className="bg-foreground/10 absolute right-1/2 top-1/2 hidden h-px w-1/2 -translate-y-1/2 rotate-90 lg:right-[8.3%] lg:block"></div>
            ...
            {features.slice(0, 3).map((feature, index) => (
              <div key={index} className="">
                <div className="group relative overflow-hidden px-4 py-8 text-center sm:py-10 lg:px-8 xl:px-13 xl:py-15 transition-all duration-300">
                  ...
                  <span className="bg-primary/10 relative mx-auto mb-8 inline-flex h-20 w-full max-w-20 items-center justify-center rounded-full">
          ...
          <div className="bg-foreground/10 hidden lg:block h-px w-full"></div>
